这里是对[CLUE 命名实体识别评测基准](https://www.cluebenchmarks.com/ner.html)解决方案的简短总结：
### CLUENER2020
利用[*google_zh_model.bin*](https://share.weiyun.com/A1C49VPb)在CLUENER2020数据集上做微调和预测的示例：
```
...
利用[*mixed_corpus_bert_large_model.bin*](https://share.weiyun.com/5G90sMJ)在CLUENER2020数据集上做微调和预测的示例：
```
