...
```
python3 scripts/generate_seq2seq.py --load_model_path models/iwslt_en_zh_model.bin-50000 \
                                    --vocab_path models/google_uncased_en_vocab.txt --tgt_vocab_path models/google_zh_vocab.txt \
